 ...
 * Copyright (c) 2009-2011 by NXTDrive, Inc. All Rights Reserved.
...
//@interface NXTDriveObject : NSObject
//@end

@interface NXTDriveObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[NXTDriveObject class]])
		{
			for (NSString *key in [[(NXTDriveObject*)o modules] allKeys])
			{
