...
/**
 The base class for all NXTDrive modules
 */
...
/**
 NXTDrive Platform calls this method on startup.
 */
-(void)startup;

/**
 NXTDrive Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 NXTDrive Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 NXTDrive Platform calls this method on resume.
 @param sender The sender of the event.
 */
