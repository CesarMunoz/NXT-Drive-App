...
// in simulator we redefine to format for NXTDrive Developer console
...
{\
	NSString * exceptionName = [@"org.nxtdrive." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.nxtdrive";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UINXTDriveNativeItemNone = -1, 
	UINXTDriveNativeItemSpinner = -2,
	UINXTDriveNativeItemProgressBar = -3,
	
	UINXTDriveNativeItemSlider = -4,
	UINXTDriveNativeItemSwitch = -5,
	UINXTDriveNativeItemMultiButton = -6,
	UINXTDriveNativeItemSegmented = -7,
	
	UINXTDriveNativeItemTextView = -8,
	UINXTDriveNativeItemTextField = -9,
	UINXTDriveNativeItemSearchBar = -10,
	
	UINXTDriveNativeItemPicker = -11,
	UINXTDriveNativeItemDatePicker = -12,
	
	UINXTDriveNativeItemInfoLight = -13,
	UINXTDriveNativeItemInfoDark = -14,
	
	UINXTDriveNativeItemDisclosure = -15,
	
	UINXTDriveNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all NXTDrive instances of
